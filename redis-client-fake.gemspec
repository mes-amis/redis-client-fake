...
Gem::Specification.new do |spec|
  ...
  spec.homepage = "https://github.com/craigmcnamara/redis-client-fake"
  spec.license = "MIT"
  spec.required_ruby_version = ">= 2.6.0"

  spec.metadata["homepage_uri"] = spec.homepage
  spec.metadata["source_code_uri"] = "https://github.com/craigmcnamara/redis-client-fake"
  spec.metadata["changelog_uri"] = "https://github.com/craigmcnamara/redis-client-fake/blob/main/CHANGELOG.md"
